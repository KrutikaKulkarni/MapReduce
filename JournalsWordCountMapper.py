...
for line in sys.stdin:
	...
	for author in authors:
		for titleword in titles: 
			author= author.translate(None, string.punctuation)
			titleword = titleword.translate(None, string.punctuation)
			if author not in allStopWords:
				if titleword not in allStopWords:
					print "{0}\t{1}" .format(author,titleword)
